...
- Push a semantic tag such as `v0.1.0` to trigger the first-class release pipeline automatically.
- The release workflow reruns the repository test/contract/runtime gates, builds `k8doc` archives for Linux, macOS, and Windows, generates `checksums.txt`, and publishes a GitHub Release with autogenerated notes.
